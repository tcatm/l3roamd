...
extern void rtnl_handle_in(struct l3ctx *ctx, int fd);
extern void rtnl_init(struct l3ctx *ctx);
extern void insert_route(struct l3ctx *ctx, const struct kernel_route *route);
